...
/// sector_1_time_minutes:         Sector 1 time whole minute part
/// sector_2_time:                 Sector 2 time in milliseconds
/// sector_2_time_minutes:         Sector 2 time whole minute part
/// delta_car_in_front_ms:         Delta to the car in front in milliseconds
/// delta_to_race_leader_ms        Delta to the race leader in milliseconds
...
struct RawLapData {
    ...
    delta_car_in_front: u16,
    delta_race_leader: u16,
    lap_distance: f32,
    total_distance: f32,
...
impl TryFrom<&RawLapData> for LapData {
    ...
    fn try_from(car_lap_data: &RawLapData) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            warnings: car_lap_data.total_warnings,
