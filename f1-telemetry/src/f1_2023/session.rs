...
use crate::f1_2023::generic::unpack_flag;
...
/// num_safety_car_periods:        Number of safety car periods in this session
/// num_virtual_safety_car_periods: Number of virtual safety cars called
/// num_red_flag_periods:          Number of red flag periods in this session
/// ```
#[derive(Deserialize)]
