...
use crate::{
    packet::{header::PacketHeader, PacketType, UnpackError},
    utils::{assert_packet_at_least_size, seconds_to_millis},
};
...
/// ## Specification
/// ```text
/// packet_format:              game year (ex. 2023)
/// game_year                   Game year - last two digits
...
/// overal_frame_identifier:    Overall identifier for the frame the data was retrieved on, doesn't go back after flashbacks
...
/// Tyre Sets               12      Extended typre set data
